...
public class snakeCanvas extends Canvas implements Runnable,KeyListener {
	...
	public void DrawEndGame(Graphics g){
		...
		endGameGraphics.drawString("You win!!!", this.getPreferredSize().width /2, this.getPreferredSize().height /2);
			...
			endGameGraphics.drawString("You lost. Your score: "+ this.score, this.getPreferredSize().width /2, this.getPreferredSize().height /2 + 20);
			endGameGraphics.drawString("Press \" space \" to start a new game!", this.getPreferredSize().width /2, (this.getPreferredSize().height/2) + 50);
